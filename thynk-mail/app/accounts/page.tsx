...
const PROVIDER_TIPS: Record<Provider, { steps: string[]; docsUrl: string; warning?: string }> = {
  ...
  zoho: {
    ...
    steps: [
      ...
      'If your email is @zohomail.in / @zoho.in: SMTP host is auto-set to smtp.zoho.in',
      '⚠️ Custom domain on Zoho India? You MUST manually set SMTP Host to smtp.zoho.in below — auto-detection only works for @zoho.in addresses',
    ],
  },
  outlook: {
...
export default function AccountsPage() {
  ...
  // Zoho also needs a visible SMTP host field — custom domains on India/EU datacenter
  // cannot be auto-detected and must manually set smtp.zoho.in or smtp.zoho.eu
